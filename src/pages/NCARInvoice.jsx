...
const NCARInvoice = () => {
	...
	const callGetBatchOfInvoices = async () => {
		await fetch(
			`http://localhost:3000/ncarinvoices/${invoiceNum.invoice1}/${invoiceNum.invoice1}`,
			{
	...
	const callCreateInvoice = async (e) => {
		...
		await fetch(
			`http://localhost:3000/ncarinvoices/${invoiceNum.invoice1}/${invoiceNum.invoice1}/${create}`,
			{
				'content-type': 'application/json',
				method: 'GET',
				//mode: 'no-cors',
	...
	const sendInvoices = async (e) => {
		...
		await fetch(`http://localhost:3000/ncarinvoice/sendInvoices/${username}`, {
			'content-type': 'application/json',
			method: 'GET',
			//mode: 'no-cors',
