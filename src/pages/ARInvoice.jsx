	...
	return (
		<div className="container mx-auto">
			<div className="flex flex-col justify-center items-center">
				{/* Grid 1 */}
				<div className="bg-[#292D32] h-auto xl:h-72 p-6 w-3/5 rounded-[30px] xl:mr-12  shadow-lg shadow-[#4D4D4D]">
								...
								<div className="flex items-center gap-20 ">
									<div className="flex  gap-4 w-3/5 h-10">
										<input
											...
											autoFocus
											type="text"
											className="w-full py-2 px-4 rounded-lg outline-none bg-white text-black font-medium placeholder-black placeholder:font-medium shadow-lg shadow-black"
									...
									<button className="relative flex items-center gap-4 py-2 px-5 text-xl font-bold overflow-hidden border-2 bg-white border-[#7063CD] rounded-lg transition-all duration-400 ease-in-out shadow-md text-[#7063CD]  hover:bg-[#7063CD] hover:text-white">
										<FaSearch />
										Consultar
									</button>
					...
					<div className="mt-12 flex justify-center gap-10 w-full flex-col xl:flex-row lg:space-x-4 space-y-4 xl:space-y-0">
						<button
							...
							className="relative flex items-center gap-4 py-2 px-5 text-white text-xl font-bold overflow-hidden bg-[#7063CD] rounded-lg transition-all duration-400 ease-in-out shadow-md  hover:bg-[white] hover:text-[#7063CD]"
						>
							<LiaFileInvoiceSolid className="w-6 h-6" />
							Generar Facturas
						</button>
						<button className="flex items-center gap-4 py-2 px-5 text-white text-xl font-bold overflow-hidden bg-[#7063CD] rounded-lg transition-all duration-400 ease-in-out shadow-md  hover:bg-[white] hover:text-[#7063CD]">
							<LiaFileInvoiceDollarSolid />
							Enviar Facturas
						</button>
