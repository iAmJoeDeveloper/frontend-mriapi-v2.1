...
const Sidebar = () => {
	...
	return (
		<div className="col-span-1">
			<sidebar className="flex flex-col justify-between gap-8 bg-[#3F3F40] text-white h-screen pt-8 p-4">
				{/* <!-- Top --> */}
				<section>
					{/* <!-- Logo --> */}
					...
					<hr className="my-8" />
					<h5 className="uppercase font-semibold text-xs text-white tracking-[2px] mb-4 ">
						Menu
					</h5>
					<ul>
						<li>
