		...
		>
			...
			<section>
				...
				<ul>
					...
					<li>
						<NavLink to='/NCInvoices' className={Linkness('NCInvoices')}>
							<svg
								xmlns='http://www.w3.org/2000/svg'
								fill='none'
								viewBox='0 0 24 24'
							...
							<span>Notas de Crédito CM</span>
						</NavLink>
					</li>
					<li>
						<NavLink to='/NCARInvoices' className={Linkness('NCARInvoices')}>
							<svg
								xmlns='http://www.w3.org/2000/svg'
								fill='none'
								viewBox='0 0 24 24'
